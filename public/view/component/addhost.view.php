<transition enter-active-class="transform transition ease-out duration-300" enter-class="opacity-0"
  enter-to-class="opacity-100" leave-active-class="ease-in duration-200" leave-class="opacity-100"
  leave-to-class="opacity-0">
  <div v-if="addHostOpen" @keydown.esc="addHostOpen = cancelForm(addHostOpen)" tabindex="-1"
        ...
        <div class="w-screen max-w-md">
          <div class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">
              ...
              <div class="px-4 sm:px-6 bg-blue-500 py-8">
                <div class="flex items-start justify-between">
                  ...
                  <div class="ml-3 h-7 flex items-center">
                    <button @click="addHostOpen = cancelForm(addHostOpen)"
                      class="bg-blue-600 rounded-md text-white hover:text-blue-200 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div class="container mx-auto max-w-lg bg-white rounded">
                  ...
                  <div class="py-2">
                    ...
                    <div class="mt-1">
                      <input required v-model="name"
                        class="outline-none shadow-sm block w-full sm:text-sm border-2 border-gray-200 py-2 px-3 rounded-md"
                        placeholder="web">
                    </div>
                  </div>
                  <div class="py-2">
                    ...
                    <div class="mt-1">
                      <input required v-model="hostname"
                        class="outline-none shadow-sm block w-full sm:text-sm border-2 border-gray-200 py-2 px-3 rounded-md"
                        placeholder="web.mydomain.io">
                    </div>
                  </div>
                  <div class="py-2">
                  ...
                  <div>
                    <div class="pt-8 pb-2">
                      ...
                      <div class="mt-1">
                        <input v-model="ressources"
                          class="outline-none shadow-sm block w-full sm:text-sm border-2 border-gray-200 py-2 px-3 rounded-md"
                          placeholder="1vCore, 2GB RAM, 20GB NVMe">
                      </div>
                    </div>
                    <div class="py-2">
                    ...
                    <div class="py-2">
                      ...
                      <div class="mt-1">
                        <input v-model="ips"
                          class="outline-none shadow-sm block w-full sm:text-sm border-2 border-gray-200 py-2 px-3 rounded-md"
                          placeholder="10.0.0.1, fd00::1">
                      </div>
                    </div>
                    <div class="py-2">
                      <label class="block text-sm font-medium text-gray-600 text-left">Price per
                        {{ billingTerm }}</label>
                      <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input v-model="price"
                          class="pl-7 pr-12 outline-none shadow-sm block w-full sm:text-sm border-2 border-gray-200 py-2 px-3 rounded-md"
                          placeholder="10">
                      </div>
                    </div>
                    <div class="py-2">
            ...
            <div class="flex-shrink-0 px-4 py-4 flex justify-end">
              <button @click="addHostOpen = cancelForm(addHostOpen)" type="button"
                class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Cancel
              </button>
              <button @click="addServer()" type="submit"
                class="ml-4 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Add
              </button>
            </div>
          </div>
