              ...
              <div class="mt-6 relative flex-1 px-4 sm:px-6">
                <div class="container mx-auto max-w-lg bg-white rounded">
                  ...
                  <div>
                    ...
                    <div class="py-2">
                      <label class="block text-sm font-medium text-gray-600 text-left">
                        Options
                      </label>
                      <div class="flex flex-wrap mt-2">
                        <input type="checkbox" id="bulkAdd" v-model="bulkAdd" class="text-left mt-1 mr-2">
                        <label for="bulkAdd" class="block text-left text-gray-600">
                          Bulk add hosts
                        </label>
                      </div> 
                      </div>
